...
import com.library.ui.menu.libraryWorkerFeatures.documentsManagement.magazineIssuesManagement.*;
...
public interface EditDocumentView {
    ...
    public default void show_update_document_window(Connection conn, Document document_to_change) {
        ...
        popup_stage.setTitle("Update a Document");
        ...
        if (document_to_change instanceof Book book_to_change) {
            // GridPane grid = book_view.get_one_book_view("📖 Modify Book", book_to_change);
            ...
            grid = document_view.get_one_magazine_issue_view("📖 Modify Magazine", magazine_issue_to_change);
            docs.add(document_view);
        }
